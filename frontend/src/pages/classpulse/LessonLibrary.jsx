        ...
        <div className="px-6 pb-6 space-y-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer select-none">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Pushes enrolled students to the join page via the extension</p>
            </div>
          </label>
          {error && <p className="text-sm text-rose-600">{error}</p>}
          <div className="flex gap-3 pt-1">
            <button onClick={onClose} disabled={starting} className="btn btn-secondary flex-1">Cancel</button>
            <button onClick={start} disabled={starting} className="btn btn-primary flex-1">
